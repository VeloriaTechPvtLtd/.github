      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 page-top pb-12 sm:pb-16">
        ...
        >
          ...
          <div className="prose prose max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">3. Project Terms</h2>
              <div className="text-muted-foreground space-y-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">6. Limitations of Liability</h2>
              <div className="text-muted-foreground space-y-4">
