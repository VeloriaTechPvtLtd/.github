          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="bg-[#1c2128] p-6 rounded-lg">
                  <h3 className="text-lg font-bold text-white mb-3">Browser Settings</h3>
                ...
                <div className="bg-[#1c2128] p-6 rounded-lg">
                  <h3 className="text-lg font-bold text-white mb-3">Opt-Out Tools</h3>
            ...
            <section className="mb-8">
              ...
              <div className="text-gray-300 space-y-4">
                ...
                <div className="bg-[#1c2128] p-6 rounded-lg">
                  <p><strong>Email:</strong> privacy@veloriatech.com</p>
